import { C as defaultDesktopAuthPath, S as defaultDesktopAuthCandidates, T as workbuddyOwnAuthPath, _ as FALLBACK_WORKBUDDY_MODELS, a as readHostHeartbeat, b as WORKBUDDY_AUTH_FILE_ENV, c as WORKBUDDY_CONNECT_VERSION, d as normalizeCredits, f as prepareChatBody, g as randomSentinel, h as probeModel, i as processStartTimeMs, l as WorkBuddyUpstreamClient, m as PROBE_EFFORT_CANDIDATES, n as clearHostHeartbeat, o as workbuddyHostHeartbeatPath, p as regionOf, r as isHeartbeatProcessAlive, s as writeHostHeartbeat, t as WORKBUDDY_HOST_HEARTBEAT_FILENAME, u as classifyUpstreamError, v as WorkBuddyCatalog, w as parseWorkBuddyAuth, x as WorkBuddyCredentialStore, y as WORKBUDDY_AUTH_FILENAME } from "./host-heartbeat-CLJYHTcT.js";
	...
	*/
	async probe(modelId, manualConsent = false) {
		...
		const run = this.queue.then(async () => {
			...
			if (cached !== void 0 && cached.validation !== "unknown") return {
				state: "ok",
...
const Config = z.object({
	...
	probeAuto: z.boolean().default(false).description("Probe new or changed undeclared models automatically after a catalog refresh")
});
/**
...
function apply(ctx, config) {
	...
	*/
	const isProbeCandidate = (info) => {
		...
		return record === void 0 || record.validation === "unknown";
	};
