		...
		for (const runtime of runtimes) {
			...
			registerWorkBuddyProbeRoute(webCtx, {
				...
				refresh: async () => {
					...
					if (known !== identity) {
						if (known !== void 0) runtime.probeStore.clear();
