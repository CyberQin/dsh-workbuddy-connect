...
function apply(ctx, config) {
	...
	*/
	const fetchCatalog = async (runtime) => {
		...
		const run = (async () => {
			...
			if (account !== void 0) runtime.savedCatalogs.set(account, {
			...
			if (runtime.inflightFetch === run) runtime.inflightFetch = void 0;
		});
