...
function createVariantRuntime(config, variant, current) {
...
function catalogSection(runtime) {
	...
	return {
		...
		...fetch === void 0 ? {} : { fetchedAt: fetch.fetchedAtMs },
...
function apply(ctx, config) {
	...
	*/
	const syncVariant = async (runtime) => {
		...
		const switched = known !== void 0 && known !== identity;
		lastIdentities.set(id, identity);
		if (switched) runtime.probeStore.clear();
