	...
	factory: (require) => {
		...
		*/
		function VisibilitySection({ models, visibility, t, busy, onToggle }) {
			if (visibility === void 0 || models === void 0 || models.length === 0) return null;
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: models.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								...
								disabled: busy,
								onChange: (event) => {
									onToggle(model.id, event.currentTarget.checked);
								}
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								style: contextPreferenceCopyStyle,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: model.name }), model.credits === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: modelRateStyle,
					...
					children: [
						...
						status?.status === "signed-in" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							...
							tab === "status" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								style: tabPanelStyle,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(VisibilitySection, {
		...
		*/
		...
		const en = {
			...
			visibilityHeading: "Model visibility",
